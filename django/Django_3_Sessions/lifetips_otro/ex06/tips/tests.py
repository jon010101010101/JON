...
class TipVoteTestCase(TestCase):
    ...
    def test_downvote_permission_low_reputation(self):
        """Verificar que los usuarios con menos de 10 puntos no pueden hacer downvotes."""
    ...
    def test_downvote_permission_high_reputation(self):
        """Verificar que los usuarios con 10 o más puntos pueden hacer downvotes."""
    ...
    def test_delete_permission_high_reputation(self):
        ...
        # Asignar permiso para eliminar tips al usuario self.user2
        content_type = ContentType.objects.get_for_model(CustomUser)
        delete_tip_permission = Permission.objects.get(codename='can_delete_tip', content_type=content_type)
        self.user2.user_permissions.add(delete_tip_permission)
        self.user2.save()

        # Verificar que el usuario tiene el permiso
        self.assertTrue(self.user2.has_perm('tips.can_delete_tip'))

        # Crear un tip asociado al usuario con permisos
        ...
        # Verificar que el tip ha sido eliminado
    ...
    def test_reputation_gain_restores_permissions(self):
        ...
        # Configurar reputación inicial por debajo del umbral (10)
        self.user1.reputation = 5
        self.user1.save()
        self.assertFalse(self.user1.has_perm('tips.can_downvote_tip'))

        # Aumentar reputación para alcanzar el umbral (10)
