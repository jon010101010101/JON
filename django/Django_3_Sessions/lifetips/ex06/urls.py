...
urlpatterns = [
    ...
    auth_views.PasswordResetView.as_view(
        template_name='registration/password_reset.html',  # Esta plantilla
        email_template_name='registration/password_reset_email.txt',  # Esta plantilla
        subject_template_name='registration/password_reset_subject.txt',  # Opcional, pero recomendado
    ),
    name='password_reset',
    ),
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name='registration/password_reset_done.html'  # Esta plantilla
        ),
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            template_name='registration/password_reset_confirm.html'  # Esta plantilla
        ),
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(
            template_name='registration/password_reset_complete.html'  # Esta plantilla
        ),
